...
Ultima actualizacion: 2026-08-25 (historial de descuentos movido a Reportes + descarga de factura en cargos pagados, PRs #91/#92).
...
Actualizado 2026-08-25: ademas de lo ya cerrado (suite de tests, unificacion de Reportes/papeleras, descuentos de Pagos a nivel-cargo, PR #89), se sumaron el mismo dia el historial de descuentos movido a Reportes con solo-activo en el perfil (PR #91) y la descarga de factura en cargos pagados via el nuevo `paymentIds` de backend (PR #92) — ambos verificados end-to-end contra el backend real. No queda ningun pendiente marcado en el roadmap salvo Tailwind (ver abajo); revisar con Jose si hay algo nuevo antes de asumir que no hay mas trabajo.
